...
def load_user_data():
@@ -59,670 +54,901 @@ def is_favorite(venue_name):
    data = load_user_data()
...
@@ -207,179 +252,274 @@ def get_acoustic_rows(audio_profile):
...
@@ -389,17 +529,18 @@ def get_acoustic_rows(audio_profile):
...
@@ -412,10 +553,10 @@ def get_acoustic_rows(audio_profile):
    st.markdown("""
    <style>
    div[data-testid="stMainBlockContainer"] .stButton > button {
...
@@ -428,6 +569,10 @@ def get_acoustic_rows(audio_profile):
...
@@ -436,25 +581,28 @@ def get_acoustic_rows(audio_profile):
        <div class="feat-card">
...
@@ -470,14 +618,14 @@ def get_acoustic_rows(audio_profile):
    ...
    with m3:
@@ -490,7 +638,7 @@ def get_acoustic_rows(audio_profile):
    ...
    with left_col:
        ...
        sentiment_html = ""
@@ -501,7 +649,7 @@ def get_acoustic_rows(audio_profile):
        ...
        st.markdown(f"""
@@ -520,11 +668,11 @@ def get_acoustic_rows(audio_profile):
        </div>
        <div class="box">
...
@@ -535,23 +683,28 @@ def get_acoustic_rows(audio_profile):
        html += '</div>'
...
# ══════════════════════════════
    ...
    with col_home:
        if st.button("🏠", key="playlist_home"):
            st.session_state.page = "home"; st.rerun()
@@ -563,161 +716,158 @@ def get_acoustic_rows(audio_profile):
    st.markdown("""
    <style>
    div[data-testid="stMainBlockContainer"] .stButton > button {
...
@@ -729,10 +879,103 @@ def get_acoustic_rows(audio_profile):
        </div>
    </div>""", unsafe_allow_html=True)
